                ...
                <div className='hide-data'>
                    ...
                    <div className='row card-links'>
                        <a onClick={eventTrack.bind(this, project.name, 'click', 'front')} href={project.front_url} 
                            className="btn col-4" target="_blank"><FontAwesomeIcon icon={faGithub} className='d-none d-sm-block'></FontAwesomeIcon>  Front</a>
                        <a onClick={eventTrack.bind(this, project.name, 'click', 'back')} href={project.back_url} 
                            className="btn col-4" target="_blank"><FontAwesomeIcon icon={faGithub} className='d-none d-sm-block'></FontAwesomeIcon>  Back</a>
                        <a onClick={eventTrack.bind(this, project.name, 'click', 'demo')} href={project.demo_url} 
                            className="btn col-4" target="_blank"><FontAwesomeIcon icon={faChrome} className='d-none d-sm-block'></FontAwesomeIcon>  Demo</a>
                    </div>
                </div>
            </div>
        </div>
